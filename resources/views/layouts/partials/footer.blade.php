<div>
    <div class="bg-gray-800 py-3 text-gray-300">
      <div class="container px-4 mx-auto">
        <div class="-mx-4 flex flex-row justify-between">
          ...
          <div class="px-4 my-4 w-full sm:w-auto">
            <div>
              <h2 class="inline-block text-xl pb-2 mb-2 border-b-4 border-blue-600">L'Entreprise</h2>
            </div>
          ...
          <div class="px-4 my-4 w-full sm:w-auto">
            <div>
              <h2 class="inline-block text-xl pb-2 mb-2 border-b-4 border-blue-600">Blog</h2>
            </div>
            <ul class="leading-8 text-sm">
          ...
          <div class="px-4 my-4 w-full sm:w-auto xl:w-1/5">
            <div>
              <h2 class="inline-block text-xl pb-2 mb-2 border-b-4 border-blue-600">Connectez-vous à nous</h2>
            </div>
