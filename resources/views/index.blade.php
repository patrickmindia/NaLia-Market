                    ...
                    <!-- component -->
                      ...
                      <div>
                        ...
                        <section class="grid grid-cols-1 sm:grid-cols-4 gap-3 px-4">
                          <!-- CARD 1 -->
                            <div class="group relative rounded-lg shadow-md cursor-pointer overflow-hidden">
                                <img class="w-full md:w-64 md:h-64 block" src="https://upload.wikimedia.org/wikipedia/en/f/f1/Tycho_-_Epoch.jpg" alt="" />
                                ...
                                <div class="block absolute bottom-0 group-hover:top-0  pb-2 bg-gray-200 bg-opacity-80 transform">
                                  <div class="relative max-h-full top-0  flex flex-col transition justify-evenly">
                                      
                                      <h6 class="text-xl text-gray-50 font-medium bg-orange-400 px-3 py-1">CDF 450,00</h6>
                                      <div class="px-3 mt-1">
